...
data = pd.read_csv(r'E:\Complete_Project2\DP\training folder\WHOLE_DATA\palm\metadataPalm.csv')
...
model.save(filepath=r"E:\Complete_Project2\DP\training folder\palm_densenet.h5")
